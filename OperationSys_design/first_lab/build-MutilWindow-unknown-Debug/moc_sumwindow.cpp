...
#include "../MutilWindow/sumwindow.h"
...
void SumWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SumWindow *_t = static_cast<SumWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject SumWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_SumWindow.data,
      qt_meta_data_SumWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SumWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SumWindow.stringdata0))
        return static_cast<void*>(const_cast< SumWindow*>(this));

...
HD_PWD='/home/strawberrylin/gitrepository/VerilogCourseDesign/mathclockdesign/course_design_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mathclock.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mathclock.tcl

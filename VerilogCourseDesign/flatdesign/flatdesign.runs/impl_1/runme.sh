...
HD_PWD='/home/strawberrylin/gitrepository/VerilogCourseDesign/flatdesign/flatdesign.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_module.vdi -applog -m64 -messageDb vivado.pb -mode batch -source main_module.tcl -notrace

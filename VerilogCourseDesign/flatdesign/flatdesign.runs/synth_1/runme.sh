...
HD_PWD='/home/strawberrylin/gitrepository/VerilogCourseDesign/flatdesign/flatdesign.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_module.vds -m64 -mode batch -messageDb vivado.pb -notrace -source main_module.tcl
